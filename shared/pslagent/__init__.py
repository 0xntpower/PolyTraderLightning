...
future graceful-shutdown hooks, future healthcheck responders — lives here so
components have exactly one import path for all of it:
...
signal is absent, so adoption is safe even before the agent is rolled out.
"""
...
__all__ = ["EnrollmentHelperError", "enroll_if_requested"]
